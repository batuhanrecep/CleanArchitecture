...
public class GetByIdBrandQuery : IRequest<GetByIdBrandResponse>
{
    ...
    public class GetByIdBrandQueryHandler : IRequestHandler<GetByIdBrandQuery, GetByIdBrandResponse> //You are a request handler for GetByIdBrandQuery and return type GetByIdBrandResponse
    {
        ...
        {
            //To test withDeleted property added to method 
